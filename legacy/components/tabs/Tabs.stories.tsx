...
import type { LegacyTabsProps } from './index.js';
...
export const Playground: Story = {
  render: ({ defaultValue = 'first', onChange, options, ...args }: LegacyTabsProps) => {
    ...
    <div style={surfaceStyle}>
      <div style={gridStyle}>
        <section style={sectionStyle}>
          ...
          <p style={metaStyle}>Активная вкладка и соседняя inactive.</p>
          <Tabs defaultValue="first" options={defaultOptions} />
        </section>
        <section style={sectionStyle}>
          <h3 style={titleStyle}>Extended group</h3>
          <p style={metaStyle}>Четыре вкладки с клавиатурной навигацией.</p>
          <Tabs
            defaultValue="first"
            options={[
              { label: 'Контент', leadingIcon: starIcon, trailingIcon: starIcon, value: 'first' },
        ...
        <section style={sectionStyle}>
          ...
          <p style={metaStyle}>Вкладки без иконок.</p>
          <Tabs
