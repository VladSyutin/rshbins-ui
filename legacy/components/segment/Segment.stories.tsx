...
import type { LegacySegmentPreviewState } from './index.js';
...
const meta = {
  title: 'Legacy/Components/Segment',
  component: Segment,
  tags: ['autodocs'],
  args: {
...
export const Playground: Story = {
  render: ({ defaultChecked = true, leadingIcon, onChange, trailingIcon, ...args }) => {
    ...
    return (
      <div style={surfaceStyle}>
        <Segment
          ...
          name="legacy-storybook-segment-playground"
          onChange={(event) => {
  ...
  render: () => (
    <div style={surfaceStyle}>
      <section style={sectionStyle}>
        ...
        <p style={metaStyle}>
          Состояния вспомогательного `_Segment` из Figma: active, inactive, focused и hover.
        </p>
        <div style={rowStyle}>
          {states.map((state) => (
            <div key={state.label} style={staticItemStyle}>
              <Segment
                ...
                label="Контент"
                leadingIcon={starIcon}
                name={'legacy-storybook-segment-overview-' + state.label}
      ...
      <section style={sectionStyle}>
        <h3 style={titleStyle}>Without icons</h3>
        <p style={metaStyle}>
          Примитив остаётся центрированным и без иконок, если в runtime их не передавать.
        </p>
        <div style={rowStyle}>
          <div style={staticItemStyle}>
            <Segment label="Контент" name="legacy-storybook-segment-without-icons" readOnly />
          </div>
          <div style={staticItemStyle}>
            <Segment checked label="Контент" name="legacy-storybook-segment-without-icons-active" readOnly />
          </div>
        </div>
      </section>
    </div>
