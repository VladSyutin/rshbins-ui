...
import InputCode from './index.js';
...
const states: Array<{
  ...
  { label: 'Typing', previewState: 'typing', value: '12' },
  { label: 'Entered', previewState: 'entered', value: '1234' },
  { label: 'Entered Hover', previewState: 'entered-hover', value: '1234' },
  {
  ...
  { label: 'Disabled Entered', previewState: 'disabled-entered', value: '1234' },
  { label: 'Keyboard Focused', previewState: 'keyboard-focused' }
];

const meta = {
  title: 'Legacy/Components/InputCode',
  component: InputCode,
  tags: ['autodocs'],
  args: {
    clearable: true,
