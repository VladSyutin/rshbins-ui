...
function GosuslugiIcon() {
  return (
    <svg aria-hidden="true" fill="none" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M5 6.6315C5 6.44329 5.15179 6.2915 5.34 6.2915H10.61C10.7982 6.2915 10.95 6.44329 10.95 6.6315V7.6515C10.95 7.83911 10.7982 7.9915 10.61 7.9915H5V6.6315Z"
        fill="currentColor"
      />
      <path
        d="M2 9.01074H12.71C12.8982 9.01074 13.05 9.16314 13.05 9.35074V10.3707C13.05 10.559 12.8982 10.7107 12.71 10.7107H2.34C2.24983 10.7107 2.16335 10.6749 2.09958 10.6112C2.03582 10.5474 2 10.4609 2 10.3707V9.01074Z"
        fill="currentColor"
      />
    </svg>
  );
...
export default function LogInThroughTheGosuslugi(props) {
  var description = props.description !== undefined
    ? props.description
    : 'Пользователь с такими данными уже зарегистрирован. Пожалуйста, подтвердите личность через Госуслуги';
  var heading = props.heading !== undefined ? props.heading : 'Войдите через Госуслуги';
