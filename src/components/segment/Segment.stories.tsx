...
import { Segment, type SegmentPreviewState } from './Segment';
    ...
    return (
      <div style={surfaceStyle}>
        <Segment
          ...
          name="storybook-segment-playground"
          onChange={(event) => {
  ...
  render: () => (
    <div style={surfaceStyle}>
      <section style={sectionStyle}>
        ...
        <p style={metaStyle}>Состояния вспомогательного `_Segment` из Figma: active, inactive, focused и hover.</p>
        <div style={rowStyle}>
          {states.map((state) => (
            <div key={state.label} style={staticItemStyle}>
              <Segment
                ...
                label="Контент"
                leadingIcon={starIcon}
                name={`storybook-segment-overview-${state.label}`}
      ...
      <section style={sectionStyle}>
        ...
        <p style={metaStyle}>Примитив остаётся центрированным и без иконок, если в runtime их не передавать.</p>
        <div style={rowStyle}>
          <div style={staticItemStyle}>
            <Segment label="Контент" name="storybook-segment-without-icons" readOnly />
          </div>
          <div style={staticItemStyle}>
            <Segment checked label="Контент" name="storybook-segment-without-icons-active" readOnly />
          </div>
        </div>
      </section>
    </div>
