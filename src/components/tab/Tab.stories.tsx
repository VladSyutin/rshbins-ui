...
import { Tab, type TabPreviewState } from './Tab';
  ...
  render: () => (
    <div style={surfaceStyle}>
      <section style={columnStyle}>
        ...
        <p style={metaStyle}>Состояния вспомогательного `_Tab` из Figma: active, hover, focused и inactive.</p>
        {states.map((state) => (
      ...
      <section style={columnStyle}>
        ...
        <p style={metaStyle}>Иконки опциональны: геометрия текста и underline остаются теми же.</p>
        <div style={rowStyle}>
