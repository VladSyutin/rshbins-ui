    ...
    <div style={surfaceStyle}>
      <div style={gridStyle}>
        <section style={sectionStyle}>
          ...
          <p style={metaStyle}>Базовая композиция из основной Figma-ноды с одним выбранным `Radio`.</p>
          <RadioGroup
            defaultValue="first"
            direction="vertical"
            options={[
        ...
        <section style={sectionStyle}>
          ...
          <p style={metaStyle}>Горизонтальная раскладка с тем же single-select поведением.</p>
          <RadioGroup
            defaultValue="first"
