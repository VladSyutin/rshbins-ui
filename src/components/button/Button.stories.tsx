...
type MatrixState = Exclude<ButtonPreviewState, 'default'> | 'default';
...
const metaStyle: CSSProperties = {
  ...
  fontWeight: varFallback('--typography-footnote-regular-fontWeight', '400'),
  lineHeight: 'var(--typography-footnote-regular-lineHeight)'
};

function varFallback(name: string, fallback: string): string {
...
function storyStateProps(state: MatrixState): Partial<ButtonProps> {
  if (state === 'default') {
    return {};
  }
